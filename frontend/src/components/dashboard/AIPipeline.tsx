...
export function AIPipeline() {
  return (
    <div className="rounded-2xl p-6 glass-panel border border-white/10 bg-white/5">
      ...
      <div className="relative pt-4 pb-6 overflow-x-auto hide-scrollbar">
        <div className="min-w-[700px] relative flex justify-between items-start w-full px-2">
          {/* Animated Connecting Line */}
          <div className="absolute top-10 left-10 right-10 h-0.5 bg-gray-800 z-0" />
          <motion.div
            className="absolute top-10 left-10 h-0.5 bg-gradient-to-r from-emerald-500 via-cyan-500 to-indigo-500 z-0"
            initial={{ width: '0%' }}
